...
#'
#' This function chooses  Ranked Set samples from specific finite population using 
...
#'
#' @return two ranked set sample matrix with sizes r1xm1 and r2xm2 from finite population. Each row indicates a cycle.
#' 
#' @examples 
#' data(otolith)
...
#'  \code{\link[RSStest]{teststat_MRSS}}, \code{\link[RSStest]{imperfectMRSS}}
...
#' 
imperfectRSS=function (df,cat,catname,aux,var,r1,r2,m1,m2){
